                    ...
                    <div className="rounded-3xl border border-[#F1E5DF] bg-white p-4 shadow-sm md:p-5">
                        <div className="mb-4 flex items-center justify-between gap-3">
                            ...
                            <button
                                ...
                                className="rounded-2xl bg-[#F28C6F] px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-[#E6765B] disabled:cursor-not-allowed disabled:opacity-40"
                            >
                    ...
                    <div className="mt-5 space-y-5">
                        ...
                        {imageInfo && (
                            <div className="grid grid-cols-2 gap-2.5 md:gap-3">
                                <div className="rounded-2xl bg-[#FFF7F3] p-2.5 md:p-4">
                                    <p className="text-[10px] font-semibold uppercase tracking-wide text-gray-400">
                                        {messages.originalSize}
                                    </p>
                                    <p className="mt-1 text-base font-semibold text-[#2A1F1B] md:text-xl">
